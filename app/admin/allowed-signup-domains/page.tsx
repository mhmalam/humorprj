    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-white/70">
          Backed by <code className="text-white/85">allowed_signup_domains</code>. Control which email domains can
          create accounts.
        </p>
      </div>
      ...
      <section className="rounded-[24px] border border-white/10 bg-white/[0.06] backdrop-blur-xl overflow-hidden shadow-[0_24px_90px_-60px_rgba(0,0,0,0.8)]">
        <div className="px-6 py-4 border-b border-white/10 flex items-center justify-between gap-4">
          <div className="text-sm font-semibold text-white/85">Existing domains</div>
        ...
        {error ? (
          ...
          <div className="divide-y divide-white/10">
            ...
            {rows.length === 0 ? (
              <div className="p-6 text-sm text-white/60">No allowed_signup_domains rows found.</div>
            ) : null}
          </div>
        )}
      </section>
