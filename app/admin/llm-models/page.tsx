    ...
    <div className="space-y-8 text-[13px] text-[var(--text-dim)]">
      <div>
        ...
        <p className="mt-2 text-[12px] text-[var(--text-dim)]">
          Backed by <code className="text-[var(--accent)]">llm_models</code>. Create, update, and delete model
          definitions.
        </p>
      </div>
      ...
      <section className="border border-[var(--border)] bg-[var(--bg-surface)] rounded-[4px] p-5">
        ...
        <p className="mt-1 text-[12px] text-[var(--text-dim)] mb-4">
          Fill in the fields below to create a new model definition.
        </p>
        <form action={createRowFromFields} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input name="name" type="text" required placeholder="e.g. GPT-4.1" className={INPUT_CLS} />
            </div>
            <div>
              <label className="block text-[11px] uppercase tracking-[0.12em] text-[var(--text-muted)] mb-2">
                provider_model_id <span className="text-red-400">*</span>
              </label>
              <input
            ...
            <div>
              ...
              <input name="llm_provider_id" type="text" placeholder="Provider ID (integer)" className={INPUT_CLS} />
            </div>
            <div>
              <label className="block text-[11px] uppercase tracking-[0.12em] text-[var(--text-muted)] mb-2">
