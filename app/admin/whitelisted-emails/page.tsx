  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-[24px] border border-white/10 bg-white/[0.06] backdrop-blur-xl p-6 shadow-[0_24px_90px_-60px_rgba(0,0,0,0.8)] overflow-hidden">
        <h2 className="text-xl font-bold font-[family-name:var(--font-space-grotesk)] tracking-tight">Add email</h2>
        ...
        <form action={createRowFromFields} className="mt-5 space-y-3">
          ...
          <div>
            <label className="block text-xs font-semibold tracking-widest text-white/55 mb-2">EMAIL ADDRESS</label>
            <input name="email" type="email" placeholder="user@example.edu" required className={INPUT_CLS} />
          </div>
